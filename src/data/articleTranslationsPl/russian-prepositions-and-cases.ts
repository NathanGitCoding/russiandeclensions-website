...
export const russianPrepositionsAndCasesPl: LearnArticle = {
  ...
  title: 'Rosyjskie przyimki i przypadki: jaki przypadek po którym przyimku?',
  metaTitle:
  ...
  internalLinks: [
    {
      ...
      label: 'Pełny przewodnik po rosyjskich przypadkach: wszystkie 6 przypadków z przykładami',
    },
    {
    ...
    },
    {
      ...
      label: 'Dopełniacz rosyjski: zasady, końcówki i 32 autentyczne przykłady',
    },
  ],
  ...
  sections: [
    {
      ...
      table: {
        ...
        rows: [
          ...
          ['Dopełniacz', 'у', 'u / przy / u (kogoś)', 'у меня', 'У меня есть кошка. — Mam kota.'],
          [
            'Dopełniacz',
            'от',
            'od (osoby / źródła)',
          ...
          ['Biernik', 'в', 'do / w (kierunek)', 'в школу', 'Я иду в школу. — Idę do szkoły.'],
          [
            'Biernik',
            'на',
            'na / w (kierunek)',
          ...
          ['Biernik', 'за', 'za (ruch) / dla', 'за угол', 'Он зашёл за угол. — Skręcił za róg.'],
          [
            'Biernik',
            'под',
            'pod (ruch)',
          ...
          ['Narzędnik', 'с', 'z / razem z', 'с другом', 'Я иду с другом. — Idę z przyjacielem.'],
          [
            'Narzędnik',
            'за',
            'za / przy (położenie)',
          ...
          ['Narzędnik', 'перед', 'przed', 'перед домом', 'Стой перед домом. — Stań przed domem.'],
          [
            'Narzędnik',
            'над',
            'nad',
      ...
      table: {
        ...
        rows: [
          [
            'в',
            'Biernik',
            'в школу (do szkoły, kierunek)',
            'Miejscownik',
            'в школе (w szkole, miejsce)',
          ],
          [
            'на',
            'Biernik',
            'на работу (do pracy, kierunek)',
            'Miejscownik',
            'на работе (w pracy, miejsce)',
          ],
          [
            'за',
            'Biernik',
