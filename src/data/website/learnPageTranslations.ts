...
const en: LearnPageTranslations = {
  ...
  articleTitles: {
    ...
    'russian-travel-phrases':
      'Russian Travel Phrases: Restaurant, Directions & Survival Vocabulary (2026)',
  },
  practiceQuiz: {
    title: 'Practice Quiz',
...
const fr: LearnPageTranslations = {
  ...
  articleTitles: {
    ...
    'russian-travel-phrases':
      'Phrases de voyage en russe : restaurant, directions et vocabulaire de survie (2026)',
  },
  practiceQuiz: {
...
const tr: LearnPageTranslations = {
  ...
  articleTitles: {
    ...
    'russian-travel-phrases':
      'Rusça Seyahat İfadeleri: Restoran, Yol Tarifi ve Hayatta Kalma Kelimeleri (2026)',
  },
  practiceQuiz: {
...
const de: LearnPageTranslations = {
  ...
  articleTitles: {
    ...
    'russian-travel-phrases':
      'Russische Reisephrasen: Restaurant, Wegbeschreibung & Überlebenswortschatz (2026)',
  },
  practiceQuiz: {
    title: 'Übungsquiz',
...
const pl: LearnPageTranslations = {
  ...
  articleTitles: {
    ...
    'russian-travel-phrases':
      'Rosyjskie zwroty podróżne: restauracja, drogowskazy i słownictwo survivalowe (2026)',
  },
  practiceQuiz: {
...
const ru: LearnPageTranslations = {
  ...
  articleTitles: {
    ...
    'russian-travel-phrases':
      'Русские фразы для путешествий: ресторан, ориентация и словарь выживания (2026)',
  },
  practiceQuiz: {
...
const es: LearnPageTranslations = {
  ...
  articleTitles: {
    ...
    'russian-travel-phrases':
      'Frases de viaje en ruso: restaurante, direcciones y vocabulario de supervivencia (2026)',
  },
  practiceQuiz: {
...
const it: LearnPageTranslations = {
  ...
  articleTitles: {
    ...
    'russian-travel-phrases':
      'Frasi di viaggio in russo: ristorante, indicazioni e vocabolario di sopravvivenza (2026)',
  },
  practiceQuiz: {
...
const pt: LearnPageTranslations = {
  ...
  articleTitles: {
    ...
    'russian-travel-phrases':
      'Frases de viagem em russo: restaurante, direções e vocabulário de sobrevivência (2026)',
  },
  practiceQuiz: {
...
const nl: LearnPageTranslations = {
  ...
  articleTitles: {
    ...
    'russian-travel-phrases':
      'Russische reiszinnen: restaurant, routebeschrijving en overlevingswoordenschat (2026)',
  },
  practiceQuiz: {
    title: 'Oefenquiz',
