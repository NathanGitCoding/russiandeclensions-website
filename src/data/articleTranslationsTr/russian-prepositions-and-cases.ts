...
export const russianPrepositionsAndCasesTr: LearnArticle = {
  ...
  title: 'Rus edatları ve haller: Her edattan sonra hangi hal kullanılır?',
  metaTitle: 'Rus edatları ve haller | Eksiksiz başvuru rehberi | Russian Cases with Anna',
  metaDescription:
  ...
  internalLinks: [
    {
      ...
      label: 'Rus halleri tam rehberi: 6 hal örneklerle açıklanıyor',
    },
    {
    ...
    },
    {
      ...
      label: 'Rus genitifi: kurallar, sonlar ve 32 gerçek örnek',
    },
  ],
  ...
  jsonLd: {
    ...
    keywords: 'Rus edatları hal, Rus edatları genitif, в на с по Rus hali',
  },
  faq: [
    {
