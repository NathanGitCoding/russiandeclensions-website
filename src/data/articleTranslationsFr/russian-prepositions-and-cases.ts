...
export const russianPrepositionsAndCasesFr: LearnArticle = {
  ...
  title: 'Prépositions et cas en russe : quel cas après chaque préposition ?',
  metaTitle: 'Prépositions et cas en russe | Guide de référence complet | Russian Cases with Anna',
  metaDescription:
      ...
      table: {
        ...
        rows: [
          [
            'в',
            'Accusatif',
            'в школу (à l’école, direction)',
            'Prépositionnel',
            'в школе (à l’école, lieu)',
          ],
          [
            'на',
            'Accusatif',
            'на работу (au travail, direction)',
            'Prépositionnel',
            'на работе (au travail, lieu)',
          ],
          [
            'за',
            'Accusatif',
  ...
  jsonLd: {
    ...
    keywords: 'prépositions cas russe, prépositions génitif russe, в на с по cas russe',
  },
  faq: [
    {
