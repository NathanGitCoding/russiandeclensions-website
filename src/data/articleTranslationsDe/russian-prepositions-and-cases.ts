...
export const russianPrepositionsAndCasesDe: LearnArticle = {
  ...
  title: 'Russische Präpositionen und Fälle: Welcher Fall folgt welcher Präposition?',
  metaTitle:
      ...
      table: {
        ...
        rows: [
          [
            'в',
            'Akkusativ',
            'в школу (zur Schule, Richtung)',
            'Präpositional',
            'в школе (in der Schule, Ort)',
          ],
          [
            'на',
            'Akkusativ',
            'на работу (zur Arbeit, Richtung)',
            'Präpositional',
            'на работе (an der Arbeit, Ort)',
          ],
          [
            'за',
            'Akkusativ',
