...
const translations: Record<Language, WaitlistModalTranslations> = {
  ...
  es_es: {
    titleIos: 'Próximamente en App Store',
    titleAndroid: 'Próximamente en Google Play',
    subtitle: 'Deja tu email y te avisaremos cuando la app esté disponible.',
    emailLabel: 'Correo electrónico',
    emailPlaceholder: 'tu@email.com',
    marketingCheckbox: 'Acepto recibir novedades y ofertas sobre Russian Cases with Anna.',
    submitButton: 'Avísame',
    submitLoading: 'Registrando...',
    cancelButton: 'Cancelar',
    closeButton: 'OK',
    successMessage: '¡Estás en la lista! Te enviaremos un email cuando se lance la app.',
    errorGeneric: 'Algo ha fallado. Por favor, inténtalo de nuevo.',
  },
  it_it: {
  ...
  pt_pt: {
    titleIos: 'Em breve na App Store',
    titleAndroid: 'Em breve no Google Play',
    subtitle: 'Deixa o teu email e avisaremos quando a app estiver disponível.',
    emailLabel: 'Endereço de email',
    emailPlaceholder: 'teu@email.com',
    marketingCheckbox: 'Aceito receber novidades e ofertas sobre Russian Cases with Anna.',
    submitButton: 'Avisa-me',
    submitLoading: 'A registar...',
    cancelButton: 'Cancelar',
    closeButton: 'OK',
    successMessage: 'Estás na lista! Enviar-te-emos um email quando a app for lançada.',
    errorGeneric: 'Algo correu mal. Por favor, tenta novamente.',
  },
  nl_nl: {
    titleIos: 'Binnenkort in de App Store',
    titleAndroid: 'Binnenkort op Google Play',
    ...
    closeButton: 'OK',
    successMessage: 'Je staat op de lijst! We mailen je wanneer de app wordt gelanceerd.',
