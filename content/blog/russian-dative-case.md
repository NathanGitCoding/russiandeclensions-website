---
title: "Russian Dative Case: Rules, Endings, нравиться & 30 Examples | Russian Cases with Anna"
description: "Complete guide to the Russian dative case: noun endings, adjectives, нравиться construction, age expressions, impersonal constructions, 8 prepositions, 15 verbs, 30 real examples."
slug: "russian-dative-case"
date: "2025-03-13"
keywords: ["russian dative case","russian dative case endings","мне нравится grammar","russian indirect object","russian dative prepositions к по","how to say to someone in russian"]
image: "/articles/free-russian-lesson-dative-case.webp"
---
...
*Dative noun endings — all genders, singular & plural*
...
*5 adjective forms with full sentence examples*
...
*7 forms with нравится examples*
...
*10 forms: present, past, future, negation*
...
![Grammar rule table: how to say your age in Russian (dative case)](/articles/how-to-say-your-age-in-russian-grammar-rule-table.webp)

*9 examples covering 1/2-4/5+ + questions and birthdays*
...
*12 constructions: нужно, можно, нельзя, etc.*
...
*8 prepositions with meaning and full examples*
...
*15 verbs with examples and notes*
...
*Dative vs. other cases comparison*
...
**Practice Russian dative case exercises on your phone**
...
- [The Complete Guide to Russian Cases](/learn/lessons/russian-cases-complete-guide)
- [Russian Case Endings: The Ultimate Cheat Sheet](/learn/articles/russian-case-endings-cheatsheet)
- [Russian Genitive Case: Rules, Endings & 32 Real Examples](/learn/articles/russian-genitive-case)
- [Russian Accusative Case: Direct Objects, Animate vs. Inanimate](/learn/articles/russian-accusative-case)
- [How to Decline in the Dative Case in Russian](/learn/lessons/dative-case-declension)
