---
title: 'Russian Instrumental Case: Endings, Professions, с + Instrumental, 30 Examples | Russian Cases with Anna'
description: 'Complete guide to the Russian instrumental case: noun endings, adjectives, professions (быть/стать/работать), с + instrumental, spatial prepositions (за/перед/над/под), time expressions, 15 verbs, 30 real examples.'
...
image: '/articles/free-russian-lesson-instrumental-case.webp'
---
...
![Instrumental case declension table: Russian noun endings by gender](/articles/instrumental-case-russian-noun-endings-declension-table.webp)

_Instrumental noun endings — all genders, singular & plural_
...
_Adjective instrumental endings_
...
_Professions with instrumental_
...
_8 prepositions with instrumental_
...
_Time expressions in instrumental_
...
- [Russian Genitive Case](/learn/articles/russian-genitive-case)
- [Russian Accusative Case](/learn/articles/russian-accusative-case)
- [Russian Dative Case](/learn/articles/russian-dative-case)
